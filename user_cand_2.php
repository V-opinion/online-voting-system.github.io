	...
	foreach($rs as $row){
		...
		<tr>
			...
			if($row['approve_status']==2){
				echo '<a href="https://online-voting-system.multireligionvalsystem.eu.org/change_status_2nd.php?id='.$cid.'&status=1" class="btn btn-success">Approve</a>';
			}else if($row['approve_status']==1){
				echo '<a href="https://online-voting-system.multireligionvalsystem.eu.org/change_status_2nd.php?id='.$cid.'&status=2" class="btn btn-danger">Reject</a>';
